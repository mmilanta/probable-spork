...
\begin{definition}[Value function]
    $$
    \h_{(G)}: V \to [0,1], \quad\quad \h_{(G)}(v) = \pr\left( \xghalf_\taughalf = \win\right).
    $$
\end{definition}
...
\begin{align*}
    ...
    \end{cases}\\
    &= \frac12 \Delta_G\left(\xghalf_{i - 1}\right)b_i,
\end{align*}
